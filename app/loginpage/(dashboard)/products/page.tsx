...
export default async function LoginpageProductsPage({
  ...
  const selectedHref = selectedProduct ? `/loginpage/products?edit=${encodeURIComponent(selectedProduct.slug)}` : "/loginpage/products";
      ...
      <section className="panel admin-product-browser">
        ...
        <div className="admin-product-selector">
          {products.map((product) => {
            const href = `/loginpage/products?edit=${encodeURIComponent(product.slug)}`;
